...
const Index  = () => {
    ...
    // destructure notification snakbar
    ...
    const handleSubmit = async (e) => {
        ...
        // check if fields are empty
         if(!form.email && !form.password){
            toast.error('fields empty!.Please fill in the fields');
            setLoading(false);
        }   
        ...
        try{
            ...
            console.error(err);
            enqueueSnackbar( "error is::" + err, { variant: 'error' });
        }
    }
    ...
    return(
        ...
        <div className="lg:flex">
            ...
            <div className="mt-8 lg:w-1/2 lg:mt-0">
                <form ref={formRef} onSubmit={handleSubmit} className="w-full lg:max-w-xl">
                ...
                <input  name="email" value={form.email} onChange={handleChange} required type="email" className="block w-full py-3 text-gray-700 bg-gray-200 border rounded-lg px-11   focus:border-blue-400  focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Email address"/>
                    ...
                    <div className="relative flex items-center mt-4">
                        ...
                        <input  name="password" value={form.password} onChange={handleChange}  required type="password" className="block w-full px-10 py-3 text-gray-700 bg-gray-200 border rounded-lg   focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password"/>
